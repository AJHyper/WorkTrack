    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.exploreGrid}>
          <TouchableOpacity
            style={[styles.exploreTile, isOperationInProgress && { opacity: 0.6 }]} // Disable if any operation is in progress
            onPress={() => router.push('/Profile')}
            disabled={isOperationInProgress} // Disable if any operation is in progress
          >
